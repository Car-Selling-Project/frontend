...
const AdminRegister = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      await registerAdmin({ name, email, phone, password, dob, gender, confirmPassword });
      setSuccessMessage("Registration successful! Redirecting...");
      setLoading(false);

      setTimeout(() => navigate("/admins/login"), 1500);
    } catch (err) {
      setLoading(false);
      ...
      <div className="flex dark:bg-gray-800 bg-white rounded-lg shadow-lg overflow-hidden max-w-6xl w-full">
        ...
        <div className="w-1/2 p-10">
          ...
          <p className="text-gray-400 mt-4 text-sm text-center">
            ...
            <a href="/admins/login" className="text-blue-400 hover:underline cursor-pointer">
              Login here
            </a>
          </p>
        </div>
