...
const AdminLogin = () => {
  ...
  const handleBlur = (field) => {
    ...
    if (field === "employeeCode") {
      newErrors.employeeCode = validateEmployeeCode(employeeCode);
    }
    if (field === "password") {
  ...
  const handleLogin = async (e) => {
    ...
    if (newErrors.employeeCode || newErrors.password) {
      setErrors(newErrors);
      return;
    }
    ...
    try {
      ...
      setTimeout(() => navigate("/admins/dashboard"), 1000);
    } catch (err) {
      setLoading(false);
      ...
      if (Array.isArray(backendErrors)) {
        ...
        backendErrors.forEach((error) => {
          mappedErrors[error.key] = error.message;
        });
    ...
    <div className="min-h-full flex items-center justify-center mt-8 dark:bg-gray-900">
      <div className="flex dark:bg-gray-800 bg-white rounded-lg shadow-lg overflow-hidden max-w-4xl w-full">
        ...
        <div className="w-1/2 p-10">
          <h2 className="dark:text-white text-primary text-2xl font-semibold mb-4">Admin Login</h2>
          ...
          <form onSubmit={handleLogin} noValidate>
            ...
            <input
              ...
              className={`w-full p-3 rounded-md dark:bg-gray-700 dark:text-white text-subtitle border ${
                errors.employeeCode ? "border-red-500" : "border-gray-600"
          ...
          <p className="text-gray-400 mt-4 text-sm text-center">
            ...
            <a href="/admins/forgot-password" className="text-blue-400 hover:underline cursor-pointer">
              Reset Password here
            </a>
          </p>
          ...
          <p className="text-gray-400 mt-4 text-sm text-center">
            ...
            <a href="/admins/register" className="text-blue-400 hover:underline cursor-pointer">
              Sign Up here
            </a>
          </p>
        </div>
        ...
        <div className="w-1/2 flex items-center justify-center dark:bg-gray-800 bg-white">
          <div className="border border-blue-600 py-24 px-10 rounded-lg text-center">
            ...
            <h2 className="dark:text-white text-primary text-2xl font-semibold mt-4">Admin Portal Log In</h2>
            <FormStatus
              loading={loading}
